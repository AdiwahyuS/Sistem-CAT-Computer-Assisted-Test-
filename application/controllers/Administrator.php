		...
		if($uri3 == "fetch_data_peserta"){
			...
			if($this->input->is_ajax_request()){
				$data = array(
					...
					'no_peserta' => $this->input->post('nopeserta',TRUE),
				...
				//cek akun ganda
				$check_data = array('no_peserta' => $this->input->post('nopeserta',TRUE));
	...
	public function dataoperator()
	{
		...
		if($uri3 == "data"){
			...
			if($this->input->is_ajax_request()){
				...
				$arr_data = array('username' => $this->input->post('username',TRUE));
